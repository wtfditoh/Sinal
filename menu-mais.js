...
function criarSheetSeNaoExiste() {
  ...
  overlay.innerHTML = `
    <div class="modal-sheet">
      ...
      <a href="eventos.html" class="mais-item">
        <span class="mais-icone"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="18" rx="2"/><path d="M16 2v4M8 2v4M3 10h18"/><circle cx="12" cy="15" r="2"/></svg></span>
        <span>Eventos <small>agenda especial da igreja</small></span>
      </a>
    </div>
  `;
